...
## My work
* I understood this lab to require the usage of semaphores, mutex, and queues
  ...
  script but all threads display that it is finished and display windows is closed.
